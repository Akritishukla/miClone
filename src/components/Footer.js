    ...
    return (
        <>
            <div className='Prefooter'>
                <div>
                    {repeatIcon}
                    <p><b>Hassel-free replacement</b> <br /> 10-days easy replacement policy on mi.com</p>
                </div>
                <div>
                    {shieldIcon}
                    <p><b>100% secure payments</b> <br /> We support Wallets, Cards, EMI, and COD </p>
                </div>
                <div>
                    {mapIcon}
            ...
            <div className='Prefooter-2'>
                <div>
                    <p>LET'S STAY IN TOUCH</p><span>Get updtaes on sales specials and more </span>
                </div>
                <div>
                    <div>
                        <input type="email" name="email" placeholder='EnterEmail Address' />
                        <button>›</button>
            ...
            <div className='footer'>
                ...
                <div>
                    <div>With our Virtual AI Bot (24/7 Live Agent Support)</div>
            ...
            <div className='footerBorder'>
                <div>Copyright © 2010 - 2022 Xiomi. All rights Reserved</div>
            </div>
